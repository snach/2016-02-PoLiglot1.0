...
you may be wrapping a lower-level_1 source which has some sort of
pause/resume mechanism, and a data callback.  In those cases, you
could wrap the low-level_1 source object by doing something like this:
...
simply by using the higher level_1 [Transform][] stream class, similar to
...
* `options` {Object}
  * `highWaterMark` {Number} Buffer level_1 when [`write()`][] starts
