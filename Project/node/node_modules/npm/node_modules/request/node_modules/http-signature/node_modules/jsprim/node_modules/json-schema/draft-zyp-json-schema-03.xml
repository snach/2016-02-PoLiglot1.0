...
http://somesite.com/45
					...
					<section title="rel">
						<t>
							...
							relation to the target resource. The relation to the target SHOULD be interpreted as specifically from the instance object that the schema (or sub-schema) applies to, not just the top level_1 resource that contains the object within its hierarchy. If a resource JSON representation contains a sub object with a property interpreted as a link, that sub-object holds the relation with the target. A relation to target from the top level_1 resource MUST be indicated with the schema describing the top level_1 JSON representation.
						</t>
