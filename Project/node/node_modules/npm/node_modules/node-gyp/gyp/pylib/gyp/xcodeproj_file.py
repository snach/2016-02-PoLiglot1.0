...
class XCObject(object):
  ...
  def _XCKVPrint(self, file, tabs, key, value):
    ...
    tabs is an int identifying the indentation level_1.  If the class'
...
class XCHierarchicalElement(XCObject):
  ...
  def Hashables(self):
    ...
    # children into a top-level_1 group like "Source", the name always goes
...
class PBXProject(XCContainerPortal):
  ...
  # FrameworksGroup and ProjectsGroup are top-level_1 groups used to collect
