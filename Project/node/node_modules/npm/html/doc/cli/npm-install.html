...
at the top level_1 because nothing conflicts with it.</p>
...
+-- C
   `-- D@2
+-- D@1
</code></pre><p>Because B&#39;s D@1 will be installed in the top level_1, C now has to install D@2
...
<p id="footer">npm-install &mdash; npm@3.7.2</p>
