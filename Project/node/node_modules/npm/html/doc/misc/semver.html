...
be used, and it is incremented by the specified level_1
...
<p>Allows patch-level_1 changes if a minor version is specified on the
comparator.  Allows minor-level_1 changes if not.</p>
<ul>
...
<p id="footer">semver &mdash; npm@3.7.2</p>
