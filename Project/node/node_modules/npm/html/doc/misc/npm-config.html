...
<p>When publishing scoped packages, the access level_1 defaults to <code>restricted</code>.  If
you want your scoped package to be publicly viewable (and installable) set
<code>--access=public</code>. The only valid values for <code>access</code> are <code>public</code> and
<code>restricted</code>. Unscoped packages <em>always</em> have an access level_1 of <code>public</code>.</p>
...
<p>What level_1 of logs to report.  On failure, <em>all</em> logs are written to
<code>npm-debug.log</code> in the current working directory.</p>
<p>Any logs of a higher level_1 than the setting are shown.
...
<ol>
<li>devDependencies are not installed at the topmost level_1 when running
...
<p>The location of user-level_1 configuration settings.</p>
...
<p id="footer">npm-config &mdash; npm@3.7.2</p>
