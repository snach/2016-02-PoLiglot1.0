...
* [`1f4b4bb`](https://github.com/npm/npm/commit/1f4b4bbdf8758281beecb7eaf75d05a6c4a77c15)
  ...
  that level_1, and updated subdeps for `validate-npm-package-license`
  ([@othiym23](https://github.com/othiym23))
...
* [`254ecfb`](https://github.com/npm/npm/commit/254ecfb04f026c2fd16427db01a53600c1892c8b)
  ...
  issue with documentation rendering where backticks in 2nd-level_1 headers would
  break rendering (?!?!)
...
* [`e7a11fd`](https://github.com/npm/npm/commit/e7a11fdf70e333cdfe3dac94a1a30907adb76d59)
  ...
  `.npmrc` to clarify that it's not read at the project level_1 when doing global
  installs.
...
* [`679bf47`](https://github.com/npm/npm/commit/679bf4745ac2cfbb01c9ce273e189807fd04fa33)
  ...
  Handle prerelease versions in top-level_1 dependencies not in `package.json`
...
license fields, and the like for top-level_1 projects (including packages you
...
SPDX-compliant licenses, the number of warnings reached a level_1 where they ran
...
they're still there, but have been pushed down a logging level_1 to `info`. You
...
* [`eb18245`](https://github.com/npm/npm/commit/eb18245f55fb4cd62a36867744bcd1b7be0a33e2)
  Only warn on normalization errors for top-level_1 dependencies. Transitive
  dependency validation warnings are logged at `info` level_1.
  ([@othiym23](https://github.com/othiym23))
...
packages, but given the level_1 of change here, that may just be a fond wish.
...
this feature has always worked, I'm classifying it as a patch-level_1 bug fix. I
...
* [`eeff04d`](https://github.com/npm/npm/commit/eeff04da7979a0181becd36b8777d607e7aa1787)
  Add `NPMOPTS` to top-level_1 install in `Makefile` to override `userconfig`.
...
* [`bdf1c84`](https://github.com/npm/npm/commit/bdf1c8483f5c4ad79b712db12d73276e15883923)
  ...
  top-level_1 Git cache directories. ([@othiym23](https://github.com/othiym23))
