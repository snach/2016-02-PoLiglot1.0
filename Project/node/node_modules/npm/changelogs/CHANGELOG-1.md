...
* [`be06213`](https://github.com/npm/npm/commit/be06213415f2d51a50d2c792b4cd0d3412a9a7b1)
  remove residual support for `win` log level_1
...
* remove normalize-package-data from top level_1, de-^-ify inflight dep
  ([@isaacs](https://github.com/isaacs))
...
* Added the `--depth` option to `npm outdated`, so that e.g. you can do `npm
  outdated --depth=0` to show only top-level_1 outdated dependencies.
