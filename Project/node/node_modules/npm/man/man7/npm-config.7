...
.RE
.P
When publishing scoped packages, the access level_1 defaults to \fBrestricted\fP\|\.  If
you want your scoped package to be publicly viewable (and installable) set
\fB\-\-access=public\fP\|\. The only valid values for \fBaccess\fP are \fBpublic\fP and
\fBrestricted\fP\|\. Unscoped packages \fIalways\fR have an access level_1 of \fBpublic\fP\|\.
.SS always\-auth
.RS 0
.IP \(bu 2
Default: false
...
.RE
.P
What level_1 of logs to report\.  On failure, \fIall\fR logs are written to
\fBnpm\-debug\.log\fP in the current working directory\.
.P
Any logs of a higher level_1 than the setting are shown\.
...
.RS 0
.IP 1. 3
devDependencies are not installed at the topmost level_1 when running
...
.RE
.P
The location of user\-level_1 configuration settings\.
.SS umask
.RS 0
.IP \(bu 2
Default: 022
